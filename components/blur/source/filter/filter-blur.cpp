...
obs_properties_t* blur_factory::get_properties2(blur_instance* data)
{
	...
	{
		p = obs_properties_add_list(pr, ST_KEY_TYPE, obs_module_text(ST_I18N_TYPE), OBS_COMBO_TYPE_LIST, OBS_COMBO_FORMAT_STRING);
		obs_property_set_modified_callback2(p, modified_properties, this);
		obs_property_list_add_string(p, obs_module_text(S_BLUR_TYPE_BOX), "box");
		obs_property_list_add_string(p, obs_module_text(S_BLUR_TYPE_BOX_LINEAR), "box_linear");
		obs_property_list_add_string(p, obs_module_text(S_BLUR_TYPE_GAUSSIAN), "gaussian");
		obs_property_list_add_string(p, obs_module_text(S_BLUR_TYPE_GAUSSIAN_LINEAR), "gaussian_linear");
		obs_property_list_add_string(p, obs_module_text(S_BLUR_TYPE_DUALFILTERING), "dual_filtering");

		p = obs_properties_add_list(pr, ST_KEY_SUBTYPE, obs_module_text(ST_I18N_SUBTYPE), OBS_COMBO_TYPE_LIST, OBS_COMBO_FORMAT_STRING);
		obs_property_set_modified_callback2(p, modified_properties, this);
		obs_property_list_add_string(p, obs_module_text(S_BLUR_SUBTYPE_AREA), "area");
		obs_property_list_add_string(p, obs_module_text(S_BLUR_SUBTYPE_DIRECTIONAL), "directional");
		obs_property_list_add_string(p, obs_module_text(S_BLUR_SUBTYPE_ROTATIONAL), "rotational");
		obs_property_list_add_string(p, obs_module_text(S_BLUR_SUBTYPE_ZOOM), "zoom");
	}

	// Blur Parameters
	{
		p = obs_properties_add_float_slider(pr, ST_KEY_SIZE, obs_module_text(ST_I18N_SIZE), 1, 32767, 1);
		p = obs_properties_add_float_slider(pr, ST_KEY_ANGLE, obs_module_text(ST_I18N_ANGLE), -180.0, 180.0, 0.01);
		p = obs_properties_add_float_slider(pr, ST_KEY_CENTER_X, obs_module_text(ST_I18N_CENTER_X), 0.00, 100.0, 0.01);
		p = obs_properties_add_float_slider(pr, ST_KEY_CENTER_Y, obs_module_text(ST_I18N_CENTER_Y), 0.00, 100.0, 0.01);

		p = obs_properties_add_bool(pr, ST_KEY_STEPSCALE, obs_module_text(ST_I18N_STEPSCALE));
		obs_property_set_modified_callback2(p, modified_properties, this);
		p = obs_properties_add_float_slider(pr, ST_KEY_STEPSCALE_X, obs_module_text(ST_I18N_STEPSCALE_X), 0.0, 1000.0, 0.01);
		p = obs_properties_add_float_slider(pr, ST_KEY_STEPSCALE_Y, obs_module_text(ST_I18N_STEPSCALE_Y), 0.0, 1000.0, 0.01);
	}

	// Masking
	{
		p = obs_properties_add_bool(pr, ST_KEY_MASK, obs_module_text(ST_I18N_MASK));
		obs_property_set_modified_callback2(p, modified_properties, this);
		p = obs_properties_add_list(pr, ST_KEY_MASK_TYPE, obs_module_text(ST_I18N_MASK_TYPE), OBS_COMBO_TYPE_LIST, OBS_COMBO_FORMAT_INT);
		obs_property_set_modified_callback2(p, modified_properties, this);
		obs_property_list_add_int(p, obs_module_text(ST_I18N_MASK_TYPE_REGION), static_cast<int64_t>(mask_type::Region));
		obs_property_list_add_int(p, obs_module_text(ST_I18N_MASK_TYPE_IMAGE), static_cast<int64_t>(mask_type::Image));
		obs_property_list_add_int(p, obs_module_text(ST_I18N_MASK_TYPE_SOURCE), static_cast<int64_t>(mask_type::Source));
		/// Region
		p = obs_properties_add_float_slider(pr, ST_KEY_MASK_REGION_LEFT, obs_module_text(ST_I18N_MASK_REGION_LEFT), 0.0, 100.0, 0.01);
		p = obs_properties_add_float_slider(pr, ST_KEY_MASK_REGION_TOP, obs_module_text(ST_I18N_MASK_REGION_TOP), 0.0, 100.0, 0.01);
		p = obs_properties_add_float_slider(pr, ST_KEY_MASK_REGION_RIGHT, obs_module_text(ST_I18N_MASK_REGION_RIGHT), 0.0, 100.0, 0.01);
		p = obs_properties_add_float_slider(pr, ST_KEY_MASK_REGION_BOTTOM, obs_module_text(ST_I18N_MASK_REGION_BOTTOM), 0.0, 100.0, 0.01);
		p = obs_properties_add_float_slider(pr, ST_KEY_MASK_REGION_FEATHER, obs_module_text(ST_I18N_MASK_REGION_FEATHER), 0.0, 50.0, 0.01);
		p = obs_properties_add_float_slider(pr, ST_KEY_MASK_REGION_FEATHER_SHIFT, obs_module_text(ST_I18N_MASK_REGION_FEATHER_SHIFT), -100.0, 100.0, 0.01);
		p = obs_properties_add_bool(pr, ST_KEY_MASK_REGION_INVERT, obs_module_text(ST_I18N_MASK_REGION_INVERT));
		/// Image
		{
			std::string filter = translate_string("%s (%s);;* (*.*)", obs_module_text(S_FILETYPE_IMAGES), S_FILEFILTERS_TEXTURE);
			_translation_cache.push_back(filter);
			p = obs_properties_add_path(pr, ST_KEY_MASK_IMAGE, obs_module_text(ST_I18N_MASK_IMAGE), OBS_PATH_FILE, _translation_cache.back().c_str(), nullptr);
		}
		/// Source
		p = obs_properties_add_list(pr, ST_KEY_MASK_SOURCE, obs_module_text(ST_I18N_MASK_SOURCE), OBS_COMBO_TYPE_LIST, OBS_COMBO_FORMAT_STRING);
		...
		/// Shared
		p = obs_properties_add_color(pr, ST_KEY_MASK_COLOR, obs_module_text(ST_I18N_MASK_COLOR));
		p = obs_properties_add_float_slider(pr, ST_KEY_MASK_ALPHA, obs_module_text(ST_I18N_MASK_ALPHA), 0.0, 100.0, 0.1);
		p = obs_properties_add_float_slider(pr, ST_KEY_MASK_MULTIPLIER, obs_module_text(ST_I18N_MASK_MULTIPLIER), 0.0, 10.0, 0.01);
	}
