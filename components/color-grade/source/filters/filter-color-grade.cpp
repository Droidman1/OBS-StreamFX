...
obs_properties_t* color_grade_factory::get_properties2(color_grade_instance* data)
{
	...
	{
		obs_properties_t* prg = obs_properties_create();
		obs_properties_add_group(pr, ST_KEY_LIFT, obs_module_text(ST_I18N_LIFT), OBS_GROUP_NORMAL, prg);

		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_LIFT_(ST_RED), obs_module_text(ST_I18N_LIFT_(ST_RED)), -1000., 100., .01);
			obs_property_float_set_suffix(p, " %");
		}
		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_LIFT_(ST_GREEN), obs_module_text(ST_I18N_LIFT_(ST_GREEN)), -1000., 100., .01);
			obs_property_float_set_suffix(p, " %");
		}
		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_LIFT_(ST_BLUE), obs_module_text(ST_I18N_LIFT_(ST_BLUE)), -1000., 100., .01);
			obs_property_float_set_suffix(p, " %");
		}
		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_LIFT_(ST_ALL), obs_module_text(ST_I18N_LIFT_(ST_ALL)), -1000., 100., .01);
			obs_property_float_set_suffix(p, " %");
		}
	}
	...
	{
		obs_properties_t* prg = obs_properties_create();
		obs_properties_add_group(pr, ST_KEY_GAMMA, obs_module_text(ST_I18N_GAMMA), OBS_GROUP_NORMAL, prg);

		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_GAMMA_(ST_RED), obs_module_text(ST_I18N_GAMMA_(ST_RED)), -1000., 1000., .01);
			obs_property_float_set_suffix(p, " %");
		}
		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_GAMMA_(ST_GREEN), obs_module_text(ST_I18N_GAMMA_(ST_GREEN)), -1000., 1000., .01);
			obs_property_float_set_suffix(p, " %");
		}
		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_GAMMA_(ST_BLUE), obs_module_text(ST_I18N_GAMMA_(ST_BLUE)), -1000., 1000., .01);
			obs_property_float_set_suffix(p, " %");
		}
		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_GAMMA_(ST_ALL), obs_module_text(ST_I18N_GAMMA_(ST_ALL)), -1000., 1000., .01);
			obs_property_float_set_suffix(p, " %");
		}
	}
	...
	{
		obs_properties_t* prg = obs_properties_create();
		obs_properties_add_group(pr, ST_KEY_GAIN, obs_module_text(ST_I18N_GAIN), OBS_GROUP_NORMAL, prg);

		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_GAIN_(ST_RED), obs_module_text(ST_I18N_GAIN_(ST_RED)), -1000., 1000., .01);
			obs_property_float_set_suffix(p, " %");
		}
		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_GAIN_(ST_GREEN), obs_module_text(ST_I18N_GAIN_(ST_GREEN)), -1000., 1000., .01);
			obs_property_float_set_suffix(p, " %");
		}
		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_GAIN_(ST_BLUE), obs_module_text(ST_I18N_GAIN_(ST_BLUE)), -1000., 1000., .01);
			obs_property_float_set_suffix(p, " %");
		}
		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_GAIN_(ST_ALL), obs_module_text(ST_I18N_GAIN_(ST_ALL)), -1000., 1000., .01);
			obs_property_float_set_suffix(p, " %");
		}
	}
	...
	{
		obs_properties_t* prg = obs_properties_create();
		obs_properties_add_group(pr, ST_KEY_OFFSET, obs_module_text(ST_I18N_OFFSET), OBS_GROUP_NORMAL, prg);

		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_OFFSET_(ST_RED), obs_module_text(ST_I18N_OFFSET_(ST_RED)), -1000., 1000., .01);
			obs_property_float_set_suffix(p, " %");
		}
		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_OFFSET_(ST_GREEN), obs_module_text(ST_I18N_OFFSET_(ST_GREEN)), -1000., 1000., .01);
			obs_property_float_set_suffix(p, " %");
		}
		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_OFFSET_(ST_BLUE), obs_module_text(ST_I18N_OFFSET_(ST_BLUE)), -1000., 1000., .01);
			obs_property_float_set_suffix(p, " %");
		}
		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_OFFSET_(ST_ALL), obs_module_text(ST_I18N_OFFSET_(ST_ALL)), -1000., 1000., .01);
			obs_property_float_set_suffix(p, " %");
		}
	}
	...
	{
		obs_properties_t* prg = obs_properties_create();
		obs_properties_add_group(pr, ST_KEY_TINT, obs_module_text(ST_I18N_TINT), OBS_GROUP_NORMAL, prg);

		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_TINT_(ST_TONE_LOW, ST_RED), obs_module_text(ST_I18N_TINT_(ST_TONE_LOW, ST_RED)), 0, 1000., .01);
			obs_property_float_set_suffix(p, " %");
		}
		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_TINT_(ST_TONE_LOW, ST_GREEN), obs_module_text(ST_I18N_TINT_(ST_TONE_LOW, ST_GREEN)), 0, 1000., .01);
			obs_property_float_set_suffix(p, " %");
		}
		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_TINT_(ST_TONE_LOW, ST_BLUE), obs_module_text(ST_I18N_TINT_(ST_TONE_LOW, ST_BLUE)), 0, 1000., .01);
			obs_property_float_set_suffix(p, " %");
		}

		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_TINT_(ST_TONE_MID, ST_RED), obs_module_text(ST_I18N_TINT_(ST_TONE_MID, ST_RED)), 0, 1000., 0.01);
			obs_property_float_set_suffix(p, " %");
		}
		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_TINT_(ST_TONE_MID, ST_GREEN), obs_module_text(ST_I18N_TINT_(ST_TONE_MID, ST_GREEN)), 0, 1000., .01);
			obs_property_float_set_suffix(p, " %");
		}
		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_TINT_(ST_TONE_MID, ST_BLUE), obs_module_text(ST_I18N_TINT_(ST_TONE_MID, ST_BLUE)), 0, 1000., .01);
			obs_property_float_set_suffix(p, " %");
		}

		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_TINT_(ST_TONE_HIGH, ST_RED), obs_module_text(ST_I18N_TINT_(ST_TONE_HIGH, ST_RED)), 0, 1000., .01);
			obs_property_float_set_suffix(p, " %");
		}
		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_TINT_(ST_TONE_HIGH, ST_GREEN), obs_module_text(ST_I18N_TINT_(ST_TONE_HIGH, ST_GREEN)), 0, 1000., .01);
			obs_property_float_set_suffix(p, " %");
		}
		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_TINT_(ST_TONE_HIGH, ST_BLUE), obs_module_text(ST_I18N_TINT_(ST_TONE_HIGH, ST_BLUE)), 0, 1000., .01);
			obs_property_float_set_suffix(p, " %");
		}
	}
	...
	{
		obs_properties_t* prg = obs_properties_create();
		obs_properties_add_group(pr, ST_KEY_CORRECTION, obs_module_text(ST_I18N_CORRECTION), OBS_GROUP_NORMAL, prg);

		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_CORRECTION_(ST_HUE), obs_module_text(ST_I18N_CORRECTION_(ST_HUE)), -180., 180., .01);
			obs_property_float_set_suffix(p, " °");
		}
		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_CORRECTION_(ST_SATURATION), obs_module_text(ST_I18N_CORRECTION_(ST_SATURATION)), 0., 1000., .01);
			obs_property_float_set_suffix(p, " %");
		}
		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_CORRECTION_(ST_LIGHTNESS), obs_module_text(ST_I18N_CORRECTION_(ST_LIGHTNESS)), 0., 1000., .01);
			obs_property_float_set_suffix(p, " %");
		}
		{
			auto p = obs_properties_add_float_slider(prg, ST_KEY_CORRECTION_(ST_CONTRAST), obs_module_text(ST_I18N_CORRECTION_(ST_CONTRAST)), 0., 1000., .01);
			obs_property_float_set_suffix(p, " %");
		}
	}
	...
	{
		obs_properties_t* prg = obs_properties_create();
		obs_properties_add_group(pr, S_ADVANCED, obs_module_text(S_ADVANCED), OBS_GROUP_NORMAL, prg);

		{
			auto                              p     = obs_properties_add_list(prg, ST_KEY_TINT_MODE, obs_module_text(ST_I18N_TINT_MODE), OBS_COMBO_TYPE_LIST, OBS_COMBO_FORMAT_INT);
			...
			for (auto kv : els) {
				obs_property_list_add_int(p, obs_module_text(kv.first), static_cast<int64_t>(kv.second));
			}
		}

		{
			auto                                   p     = obs_properties_add_list(prg, ST_KEY_TINT_DETECTION, obs_module_text(ST_I18N_TINT_DETECTION), OBS_COMBO_TYPE_LIST, OBS_COMBO_FORMAT_INT);
		...
		obs_properties_add_float_slider(prg, ST_KEY_TINT_EXPONENT, obs_module_text(ST_I18N_TINT_EXPONENT), 0., 10., .01);

		{
			auto                            p     = obs_properties_add_list(prg, ST_KEY_RENDERMODE, obs_module_text(ST_I18N_RENDERMODE), OBS_COMBO_TYPE_LIST, OBS_COMBO_FORMAT_INT);
			...
			for (auto kv : els) {
				obs_property_list_add_int(p, obs_module_text(kv.first), kv.second);
			}
		}
	}
