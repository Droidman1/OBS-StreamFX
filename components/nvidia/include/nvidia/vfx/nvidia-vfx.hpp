...
namespace streamfx::nvidia::vfx {
	...
	static constexpr parameter_t PARAMETER_CUDA_GRAPH         = "CudaGraph"; // UINT32, 1 for On, 0 for Off
	static constexpr parameter_t PARAMETER_INFO               = "Info";
	static constexpr parameter_t PARAMETER_MAX_INPUT_WIDTH    = "MaxInputWidth"; // UINT32
	static constexpr parameter_t PARAMETER_MAX_INPUT_HEIGHT   = "MaxInputHeight"; // UINT32
	static constexpr parameter_t PARAMETER_MAX_NUMBER_STREAMS = "MaxNumberStreams"; // UINT32
	...
	static constexpr parameter_t PARAMETER_STATE_COUNT        = "NumStateObjects";
