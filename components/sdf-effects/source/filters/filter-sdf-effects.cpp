...
obs_properties_t* sdf_effects_factory::get_properties2(sdf_effects_instance* data)
{
	...
	{ // Shadow Outer
		auto prg = obs_properties_create();
		obs_properties_add_group(pr, ST_KEY_SHADOW_OUTER, obs_module_text(ST_I18N_SHADOW_OUTER), OBS_GROUP_CHECKABLE, prg);

		obs_properties_add_float_slider(prg, ST_KEY_SHADOW_OUTER_RANGE_MINIMUM, obs_module_text(ST_I18N_SHADOW_OUTER_RANGE_MINIMUM), -16.0, 16.0, 0.01);
		obs_properties_add_float_slider(prg, ST_KEY_SHADOW_OUTER_RANGE_MAXIMUM, obs_module_text(ST_I18N_SHADOW_OUTER_RANGE_MAXIMUM), -16.0, 16.0, 0.01);
		obs_properties_add_float_slider(prg, ST_KEY_SHADOW_OUTER_OFFSET_X, obs_module_text(ST_I18N_SHADOW_OUTER_OFFSET_X), -100.0, 100.0, 0.01);
		obs_properties_add_float_slider(prg, ST_KEY_SHADOW_OUTER_OFFSET_Y, obs_module_text(ST_I18N_SHADOW_OUTER_OFFSET_Y), -100.0, 100.0, 0.01);
		obs_properties_add_color(prg, ST_KEY_SHADOW_OUTER_COLOR, obs_module_text(ST_I18N_SHADOW_OUTER_COLOR));
		obs_properties_add_float_slider(prg, ST_KEY_SHADOW_OUTER_ALPHA, obs_module_text(ST_I18N_SHADOW_OUTER_ALPHA), 0.0, 100.0, 0.1);
	}

	{ // Shadow Inner
		auto prg = obs_properties_create();
		obs_properties_add_group(pr, ST_KEY_SHADOW_INNER, obs_module_text(ST_I18N_SHADOW_INNER), OBS_GROUP_CHECKABLE, prg);

		obs_properties_add_float_slider(prg, ST_KEY_SHADOW_INNER_RANGE_MINIMUM, obs_module_text(ST_I18N_SHADOW_INNER_RANGE_MINIMUM), -16.0, 16.0, 0.01);
		obs_properties_add_float_slider(prg, ST_KEY_SHADOW_INNER_RANGE_MAXIMUM, obs_module_text(ST_I18N_SHADOW_INNER_RANGE_MAXIMUM), -16.0, 16.0, 0.01);
		obs_properties_add_float_slider(prg, ST_KEY_SHADOW_INNER_OFFSET_X, obs_module_text(ST_I18N_SHADOW_INNER_OFFSET_X), -100.0, 100.0, 0.01);
		obs_properties_add_float_slider(prg, ST_KEY_SHADOW_INNER_OFFSET_Y, obs_module_text(ST_I18N_SHADOW_INNER_OFFSET_Y), -100.0, 100.0, 0.01);
		obs_properties_add_color(prg, ST_KEY_SHADOW_INNER_COLOR, obs_module_text(ST_I18N_SHADOW_INNER_COLOR));
		obs_properties_add_float_slider(prg, ST_KEY_SHADOW_INNER_ALPHA, obs_module_text(ST_I18N_SHADOW_INNER_ALPHA), 0.0, 100.0, 0.1);
	}

	{ // Glow Outer
		auto prg = obs_properties_create();
		obs_properties_add_group(pr, ST_KEY_GLOW_OUTER, obs_module_text(ST_I18N_GLOW_OUTER), OBS_GROUP_CHECKABLE, prg);

		obs_properties_add_color(prg, ST_KEY_GLOW_OUTER_COLOR, obs_module_text(ST_I18N_GLOW_OUTER_COLOR));
		obs_properties_add_float_slider(prg, ST_KEY_GLOW_OUTER_ALPHA, obs_module_text(ST_I18N_GLOW_OUTER_ALPHA), 0.0, 100.0, 0.1);
		obs_properties_add_float_slider(prg, ST_KEY_GLOW_OUTER_WIDTH, obs_module_text(ST_I18N_GLOW_OUTER_WIDTH), 0.0, 16.0, 0.01);
		obs_properties_add_float_slider(prg, ST_KEY_GLOW_OUTER_SHARPNESS, obs_module_text(ST_I18N_GLOW_OUTER_SHARPNESS), 0.00, 100.0, 0.01);
	}

	{ // Glow Inner
		auto prg = obs_properties_create();
		obs_properties_add_group(pr, ST_KEY_GLOW_INNER, obs_module_text(ST_I18N_GLOW_INNER), OBS_GROUP_CHECKABLE, prg);

		obs_properties_add_color(prg, ST_KEY_GLOW_INNER_COLOR, obs_module_text(ST_I18N_GLOW_INNER_COLOR));
		obs_properties_add_float_slider(prg, ST_KEY_GLOW_INNER_ALPHA, obs_module_text(ST_I18N_GLOW_INNER_ALPHA), 0.0, 100.0, 0.1);
		obs_properties_add_float_slider(prg, ST_KEY_GLOW_INNER_WIDTH, obs_module_text(ST_I18N_GLOW_INNER_WIDTH), 0.0, 16.0, 0.01);
		obs_properties_add_float_slider(prg, ST_KEY_GLOW_INNER_SHARPNESS, obs_module_text(ST_I18N_GLOW_INNER_SHARPNESS), 0.00, 100.0, 0.01);
	}

	{ // Outline
		auto prg = obs_properties_create();
		obs_properties_add_group(pr, ST_KEY_OUTLINE, obs_module_text(ST_I18N_OUTLINE), OBS_GROUP_CHECKABLE, prg);

		obs_properties_add_color(prg, ST_KEY_OUTLINE_COLOR, obs_module_text(ST_I18N_OUTLINE_COLOR));
		obs_properties_add_float_slider(prg, ST_KEY_OUTLINE_ALPHA, obs_module_text(ST_I18N_OUTLINE_ALPHA), 0.0, 100.0, 0.1);

		obs_properties_add_float_slider(prg, ST_KEY_OUTLINE_WIDTH, obs_module_text(ST_I18N_OUTLINE_WIDTH), 0.0, 16.0, 0.01);

		obs_properties_add_float_slider(prg, ST_KEY_OUTLINE_OFFSET, obs_module_text(ST_I18N_OUTLINE_OFFSET), -16.0, 16.0, 0.01);

		obs_properties_add_float_slider(prg, ST_KEY_OUTLINE_SHARPNESS, obs_module_text(ST_I18N_OUTLINE_SHARPNESS), 0.00, 100.0, 0.01);
	}
	...
	{ // Advanced Options
		...
		obs_properties_add_float_slider(prg, ST_KEY_SDF_SCALE, obs_module_text(ST_I18N_SDF_SCALE), 0.1, 500.0, 0.1);
		obs_properties_add_float_slider(prg, ST_KEY_SDF_THRESHOLD, obs_module_text(ST_I18N_SDF_THRESHOLD), 0.0, 100.0, 0.01);
	}
