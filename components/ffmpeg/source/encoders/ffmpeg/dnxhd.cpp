...
// Copyright (C) 2022-2024 Michael Fabian 'Xaymar' Dirks <info@xaymar.com>
...
void dnxhd::properties(ffmpeg_factory* factory, ffmpeg_instance* instance, obs_properties_t* props)
{
	...
	auto p = obs_properties_add_list(props, S_CODEC_DNXHR_PROFILE, obs_module_text(S_CODEC_DNXHR_PROFILE), OBS_COMBO_TYPE_LIST, OBS_COMBO_FORMAT_STRING);
